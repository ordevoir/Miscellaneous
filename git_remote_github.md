...
1. В первую очередь необходимо установить расширение **GitHub Pull Requests and Issues**.
2. Щелкните Учетная запись в нижней левой части панели действий и выберите **Войти для использования GitHub Pull Requests and Issues**. Предоставляем доступ к GitHub. Окно Visual Studio Code откроется снова, и вы выполните вход. Вы можете убедиться в этом, щелкнув значок учетной записи и увидев имя пользователя GitHub.
